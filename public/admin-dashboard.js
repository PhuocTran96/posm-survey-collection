class AdminDashboard {
  ...
  loadUserInfo() {
    if (this.currentUser) {
      ...
      document.getElementById('userRole').textContent = this.currentUser.isSuperAdmin
        ? 'Super Admin'
        : 'Administrator';
    ...
    try {
      ...
      if (response.ok) {
        ...
        this.showNotification(
          `Import thành công: ${result.data.stats.created} tạo mới, ${result.data.stats.updated} cập nhật`,
          'success'
        );
